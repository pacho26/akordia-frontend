...
<template>
  ...
  >
    <div>
      ...
      <div m="sm:t-2" text="gray-800 2xl sm:3xl" font="600">
        {{ song.title }}
      </div>
  ...
  <div flex="~ gap-8 wrap" justify="between" m="t-6">
    <RichTextEditor read-only :content="song.content" />
